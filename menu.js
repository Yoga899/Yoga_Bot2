exports.menu = (id, YogaBot, corohelp, tampilTanggal, tampilWaktu, instagram, aktif) => {
	return ` *${YogaBot}*
...
├≽️ *.Group* 
├_https://chat.whatsapp.com/E6LjxLZ0kMWHBU5Y1UhOEv
├≽️ *.Owner*
├ _wa.me/083135395481_
╰═══════════════
...
├ _Ex = .Arti Yoga_
├≽️ *.Couple (Namamu & doi)*
├ _Ex = .Couple Yoga & udan_
├≽️ *.Getzodiak*
├ _Ex : .Getzodiak Yoga &  23-03-2000_
├≽️ *.Zodiak (zodiak)*
├ _Ex : .Zodiak libra_
├≽️ *.Mimpi (teks)*
├ _Ex : .Mimpi ular_
...
├ _Ex = .Kata Aku cinta dia/Fitria_
├≽️ *.Logopornhub (teks1/teks2)*
├ _Ex : .Logopornhub Ilham/nime
├≽️ *.Logoesport (teks)*
├ _Ex : .Logoesport Ilham_(❌)
╰═══════════════
